    ...
    <main
      ...
      >
        <section className="left relative flex flex-col h-full min-w-96 bg-slate-300">
            ...
            <div className="consversation-area flex-grow flex flex-col ">
                ...
                className="message-box p-1 flex-grow flex flex-col gap-1">
                    <div className="message max-w-56 flex flex-col p-2 bg-slate-50 w-fit rounded-md">
                        ...
                        <p className='text-sm'>Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet con!</p>
                    </div>
                    <div className="ml-auto max-w-56 meassage flex flex-col p-2 bg-slate-50 w-fit rounded-md">
                        <small
                        className='opacity-65 text-xs'>Example@gmail.com</small>
            ...
            <header
                className='flex justify-between items-center p-2 px-4 bg-slate-200'>
            ...
            <div className='users flex flex-col gap-2 p-2'>
                {project.users && project.users.map(user => {
                    ...
                    <h1
                    className='font-semibold text-lg'>{user.email}</h1>
                </div>
                    )
                })}
